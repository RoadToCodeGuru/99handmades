...
<html lang="en">
  ...
  <style>
    ...
    */
    ...
    background: -moz-radial-gradient(center center, circle farthest-corner, #310303 10%, #400D0D);
    background: -webkit-radial-gradient(center center, circle farthest-corner, #310303 10%, #400D0D);
    background: radial-gradient(circle farthest-corner at center center, #310303 10%, #400D0D);
    color: #fff;
  ...
  <body>
    <div  id="exDom" class="container">
      <div class="invoice-top">
        <section id="memo">
          <div class="logo">
          <img src="{{URL('theme/assets/images/users/staypretty.png')}}" >
          </div>
          
          <div class="company-info">
            <span class="company-name">Stay Pretty</span>
            ...
            <div>jessie.yadanar99@gmail.com |  09 975-451-686 , 09 972-023-950</div>
            <span class="clearfix"></span>
      ...
      <div class="invoice-body">
        ...
        <div class="payment-info">
            <h6>Kbz Pay မှ 09 975-451-686, 09 972-023-950 သို့လွှဲ၍ပေးချေနိုင်ပါသည်</h6>
        </div>
      </div>
